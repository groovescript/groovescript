...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 120" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "A: 8" } \vspace #0.3 \italic \fontsize #-1 "Play 8x" }
      \bar ".|:"
      \repeat volta 8 {
      ...
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "A2: 8" } \vspace #0.3 \italic \fontsize #-1 "Play 8x" }
      \repeat volta 8 {
        <bd hh>8 hh8 <sn hh>8 hh8 <sn hh>8 hh8 |
      }
      \label #'lastPage
