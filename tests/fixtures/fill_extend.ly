...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 120" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "DRIVING SNARE ROLL: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 3x" }
      \bar ".|:"
      \repeat volta 3 {
        <hh bd>8 hh8 <hh sn>8 hh8 <hh bd>8 hh8 <hh sn>8 hh8 |
      }
      <sn bd>16 sn16 sn16 sn16 <sn bd>16 sn16 sn16 sn16 <sn bd>16 sn16 sn16 sn16 <sn bd>16 sn16 sn16 sn16 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "BIG HIT OPENER: 4" }
      <bd cymc>4 r4 r4 r4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      ...
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "LAYERED TWO-BAR: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 2x" }
      \repeat volta 2 {
        <hh bd>8 hh8 <hh sn>8 hh8 <hh bd>8 hh8 <hh sn>8 hh8 |
      }
      hh4 hh4 <sn hh>16 sn16 sn16 sn16 <sn hh>16 sn16 sn16 sn16 |
      <bd cymc hh>4 <bd hh>4 <bd hh>4 <bd hh>4 |
      \label #'lastPage
    }
  }
}
