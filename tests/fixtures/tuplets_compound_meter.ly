...
\score {
\header {
  subtitle = "Tempo: 90    Time Signature: 6/8"
}
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 8 } #1 " = 90" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "COMPOUND SEXTUPLET: 1" } }
      \tuplet 6/4 { <hh bd>32-> hh32 hh32 hh32-> hh32 hh32 } hh8 hh8 \tuplet 6/4 { <hh bd>32-> hh32 hh32 hh32-> hh32 hh32 } hh8 hh8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "COMPOUND QUINTUPLET: 1" }
      \tuplet 5/4 { <hh bd>32 hh32 hh32 hh32 hh32 } hh8 hh8 \tuplet 5/4 { <hh bd>32 hh32 hh32 hh32 hh32 } hh8 hh8 |
      \label #'lastPage
    }
  }
}
