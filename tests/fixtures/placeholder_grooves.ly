...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "PRE-CHORUS: 4" }
      s4^\markup { \bold \box \fontsize #-1 "hookline tease" } s4 s4 s4 |
      s4 s4 s4 s4 |
      s4 s4 s4 s4 |
      s4 s4 s4 s4 | \break
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      ...
      s4^\markup { \bold \box \fontsize #-1 "verse-A" } s4 s4 s4 |
      s4 s4 s4 s4 |
      s4 s4 s4 s4 |
      s4 s4 s4 s4 | \break
      s4 s4 s4 s4 |
      ...
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "CHORUS: 16" }
      s4^\markup { \bold \box \fontsize #-1 "Chorus groove 1" } s4 s4 s4 |
      s4 s4 s4 s4 |
      s4 s4 s4 s4 |
      s4 s4 s4 s4 | \break
      s4^\markup { \bold \box \fontsize #-1 "build" } s4 s4 s4 |
      s4 s4 s4 s4 |
      s4^\markup { \bold \box \fontsize #-1 "outro idea" } s4 s4 s4 |
      s4 s4 s4 s4 | \break
      s4 s4 s4 s4 |
      s4 s4 s4 s4 | \break
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      ...
      s4^\markup { \bold \box \fontsize #-1 "Chorus groove 2" } s4 s4 s4 |
      s4 s4 s4 s4 | \break
      \label #'lastPage
    }
  }
