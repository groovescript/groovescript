...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 120" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "ROCK: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 3x" }
      \bar ".|:"
      \repeat volta 3 {
      ...
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "JAZZ RIDE: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 3x" }
      \repeat volta 3 {
        <cymr bd>4 \tuplet 3/2 { <cymr sn>8 r8 cymr8 } <cymr bd>4 \tuplet 3/2 { <cymr sn>8 r8 cymr8 } |
      }
      r4 r4 r4 <bd cymc>4 |
      \label #'lastPage
    }
