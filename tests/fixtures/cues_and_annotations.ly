...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      <bd hh>8^\markup { \italic \fontsize #-1 "Intro" } hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      ...
      <bd hh>8^\markup { \italic \fontsize #-1 "Verse — vocals enter" } hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \once \override Score.RehearsalMark.outside-staff-priority = #1000
      \mark \markup \italic \fontsize #-1 "Play 5x"
      \repeat volta 5 {
        <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      }
      <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8^\markup { \italic \fontsize #-1 "Build" } hh8 <sn hh>8 hh8 |
      r4 r4 r4 <bd cymc>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "CHORUS: 8" } \vspace #0.3 \italic \fontsize #-1 "Big feel" }
      <bd hh>8^\markup { \italic \fontsize #-1 "Chorus" } hh8 <sn hh>8 <bd hh>8 <bd hh>8 hh8 <sn hh>8 hh8 |
      <bd cymr>8 cymr8 <sn cymr>8 cymr8 <bd cymr>8 cymr8 <sn cymr>8 cymr8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \mark \markup { \fontsize #-1 "Big feel" }
      <bd hh>8 hh8 <sn hh>8 <bd hh>8 <bd hh>8 hh8 <sn hh>8 hh8 |
      <bd cymr>8 cymr8 <sn cymr>8 cymr8 <bd cymr>8 cymr8 <sn cymr>8 cymr8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \mark \markup { \fontsize #-1 "Big feel" }
      ...
      <bd hh>8^\markup { \italic \fontsize #-1 "Outro — fade" } hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \once \override Score.RehearsalMark.outside-staff-priority = #1000
