...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 120" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "VERSE: 4" } \vspace #0.3 \italic \fontsize #-1 "Quarter note pulse" }
      <hh bd>8 hh8 <hh sn>8 hh8 <hh bd>8 <hh bd>8 <hh sn>8 hh8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \mark \markup { \fontsize #-1 "Quarter note pulse" }
      <hh bd>8 hh8 <hh sn>8 hh8 <hh bd>8 <hh bd>8 <hh sn>8 hh8 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \mark \markup { \fontsize #-1 "Quarter note pulse" }
