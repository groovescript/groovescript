...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \repeat volta 4 {
        <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
        <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8 hho8 <sn hh>8 hh8 |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "CHORUS: 8" } \vspace #0.3 \italic \fontsize #-1 "Play 7x" }
      \repeat volta 7 {
        <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      }
