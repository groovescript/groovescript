...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 100" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "INTRO: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 4x" }
      \bar ".|:"
      \repeat volta 4 {
        <bd hh>16 hh32 hh32 hh16 hh16 <sn hh>16 hh16 hh16 hh16 <bd hh>16 hh32 hh32 hh16 hh16 <sn hh>16 hh16 hh16 hh32 hh32 |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "OUTRO: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 3x" }
      \repeat volta 3 {
        <bd hh>16 hh32 hh32 hh16 hh16 <sn hh>16 hh16 hh16 hh16 <bd hh>16 hh32 hh32 hh16 hh16 <sn hh>16 hh16 hh16 hh32 hh32 |
      }
      \parenthesize sn32 \parenthesize sn32 sn16 sn32 sn32 sn16 sn16 \parenthesize sn32 \parenthesize sn32 sn16 sn16 sn32 sn32 sn16 sn32 sn32 sn16 bd16 sn16 bd16 cymc16 |
      \label #'lastPage
    }
  }
}
