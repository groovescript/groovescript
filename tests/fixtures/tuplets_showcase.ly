...
\score {
\header {
  subtitle = "Tempo: 100    Time Signature: 4/4"
}
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 100" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "SEXTUPLET ON 2: 1" } }
      <hh bd>4 \tuplet 6/4 { <hh sn>16-> hh16 hh16 hh16-> hh16 hh16 } <hh bd>4 <hh sn>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "16TH-NOTE TRIPLETS: 1" }
      <hh bd>4 <hh sn>4 \tuplet 3/2 { <hh bd>16 hh16 hh16 } \tuplet 3/2 { hh16 hh16 hh16 } <hh sn>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "QUINTUPLET: 1" }
      \tuplet 5/4 { <hh bd>16 hh16 hh16 hh16 hh16 } <hh sn>4 <hh bd>4 <hh sn>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "SEPTUPLET: 1" }
      <hh bd>4 <hh sn>4 <hh bd>4 \tuplet 7/4 { hh16 hh16 hh16 hh16 hh16 hh16 hh16 } |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "NONUPLET: 1" }
      \tuplet 9/8 { <hh bd>32 hh32 hh32 hh32 hh32 hh32 hh32 hh32 hh32 } <hh sn>4 <hh bd>4 <hh sn>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "SEXTUPLET STAR: 2" } \vspace #0.3 \italic \fontsize #-1 "Play 2x" }
      \repeat volta 2 {
        \tuplet 6/4 { <hh bd>16 hh16 hh16 hh16 hh16 hh16 } \tuplet 6/4 { <hh sn>16 hh16 hh16 hh16 hh16 hh16 } \tuplet 6/4 { <hh bd>16 hh16 hh16 hh16 hh16 hh16 } \tuplet 6/4 { <hh sn>16 hh16 hh16 hh16 hh16 hh16 } |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "TOM-RUN FILL: 2" }
      <hh bd>4 \tuplet 6/4 { <hh sn>16-> hh16 hh16 hh16-> hh16 hh16 } <hh bd>4 <hh sn>4 |
      bd4 \tuplet 6/4 { tomh16 tommh16 tomfh16 bd16 tomh16 tommh16 } bd4 <bd cymc>4 |
      \label #'lastPage
    }
  }
}
