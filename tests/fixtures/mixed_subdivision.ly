...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 120" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "EIGHTH+TRIPLET: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 4x" }
      \bar ".|:"
      \repeat volta 4 {
        <bd hh>8 hh8 <sn hh>8 hh8 \tuplet 3/2 { bd8 sn8 sn8 } \tuplet 3/2 { sn8 sn8 sn8 } |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "SIXTEENTH+TRIPLET: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 4x" }
      \repeat volta 4 {
        bd16 bd16 bd16 bd16 bd16 bd16 bd16 bd16 \tuplet 3/2 { r8 sn8 sn8 } \tuplet 3/2 { r8 sn8 sn8 } |
      }
      \label #'lastPage
    }
  }
