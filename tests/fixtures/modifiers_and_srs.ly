...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \bar ".|:"
      \repeat volta 3 {
        \slashedGrace sn16 <bd sn>4 <sn hh>8-> hh8 <bd hh>8 hh8 <sn hh>8-> hh8 |
      }
      \slashedGrace sn16 <bd sn>4 <sn hh>8-> hh8 \slashedGrace sn16 sn16 sn16 \grace { sn16 sn16 } sn16 sn16 <bd cymc>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      ...
      \slashedGrace sn16 <bd sn>4 <sn hh>8-> <hh \parenthesize sn>8 <bd hh>8 hh8 <hh \parenthesize sn>8 hh8 |
      \label #'lastPage
    }
  }
}
