...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 112" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "INTRO: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 3x" }
      \bar ".|:"
      \repeat volta 3 {
        <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      }
      <bd hh>8 hh8 <sn hh>8 hh8 \tuplet 3/2 { sn8 sn8 sn8 } <bd cymc>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "VERBOSE POSITIONAL: 2" } \vspace #0.3 \italic \fontsize #-1 "Play 2x" }
      \repeat volta 2 {
        \tuplet 3/2 { bd8 sn8 sn8 } bd4 \tuplet 3/2 { bd8 sn8 sn8 } bd4 |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(left-edge)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "BARE COUNT TOKENS: 2" }
      <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      \tuplet 3/2 { bd8 sn8 sn8 } bd4 r4 r4 |
      \label #'lastPage
    }
  }
}
