...
\header {
  ...
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      tomfh8 tomfh8 tomfh8 tomfh8 tomfh8 tomfh8 r4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "CHORUS: 4" } \vspace #0.3 \italic \fontsize #-1 "Play 3x" }
      \repeat volta 3 {
        <bd hh>8 hh8 <sn hh>8 hh8 <bd hh>8 hh8 <sn hh>8 hh8 |
      }
      hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 hh16 |
      \label #'lastPage
    }
  }
}
