...
\score {
\header {
  subtitle = "Tempo: 160    Time Signature: 4/4"
}
  \new DrumStaff \with {
    ...
    \drummode {
      ...
      \mark \markup \column { \fontsize #-1 \concat { \note { 4 } #1 " = 160" } \vspace #0.3 \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "HEAD: 8" } \vspace #0.3 \italic \fontsize #-1 "Play 4x" }
      \bar ".|:"
      \repeat volta 4 {
        cymr8 cymr8 <cymr hh sn>8 cymr8 cymr8 cymr8 <cymr hh sn>8 cymr8 |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      ...
      sn16 sn16 sn16 sn16 sn16 sn16 sn16 sn16 tomh16 tomh16 tomh16 tomh16 <bd cymc>4 |
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "SOLOS: 16" } \vspace #0.3 \italic \fontsize #-1 "Play 4x" }
      \repeat volta 4 {
        cymr8 cymr8 <cymr hh sn>8 cymr8 cymr8 cymr8 <cymr hh sn>8 cymr8 |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      ...
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
      \mark \markup \column { \override #'(box-padding . 0.5) \box \bold \fontsize #-1 { "HEAD OUT: 8" } \vspace #0.3 \italic \fontsize #-1 "Play 4x" }
      \repeat volta 4 {
        <cymr bd>8 cymr8 <cymr hh>8 cymr8 <cymr bd>8 cymr8 <cymr hh>8 cymr8 |
      }
      \once \override Score.RehearsalMark.self-alignment-X = #LEFT
      \once \override Score.RehearsalMark.break-align-symbols = #'(staff-bar)
      \once \override Score.RehearsalMark.padding = #2
